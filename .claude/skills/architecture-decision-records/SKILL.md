...
<details>
<summary>Full example: PostgreSQL as Primary Database</summary>
...
<details>
<summary>Full example: Event Sourcing for Order Management</summary>
...
| Missing "Rejected" ADRs | Loses valuable context on what didn't work | Document rejected options too |
...
- **Include rejected options** — future context
