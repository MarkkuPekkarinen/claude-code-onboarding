...
- `references/glsl-reference.md` — GLSL built-in functions (math, vector, texture), ShaderMaterial full property list, shader includes/chunks, external .glsl files, instanced shaders, debugging, and performance tips
