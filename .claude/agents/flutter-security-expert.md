...
1. **Harden client-side security** — secure storage, certificate pinning, obfuscation
2. **Enforce privacy compliance** — GDPR/CCPA consent management, data subject rights
3. **Review mobile-specific risks** — deep link hijacking, reverse engineering, local data exposure
4. **Audit data retention** — automated cleanup policies, minimal collection
