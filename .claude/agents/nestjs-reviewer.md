...
- `reference/nestjs-config.md` — package.json, tsconfig, static config reader, Prisma schema
- `reference/nestjs-templates.md` — main.ts, app.module, feature module, controller, service templates
- `reference/nestjs-enterprise.md` — exception hierarchy, security middleware, rate limiting, health checks
- `reference/nestjs-resilience.md` — circuit breaker, database fallback, request context, feature flags
- `reference/nestjs-observability.md` — OpenTelemetry, structured logging, cloud logging
- `reference/nestjs-messaging.md` — BullMQ, RabbitMQ, Kafka patterns
