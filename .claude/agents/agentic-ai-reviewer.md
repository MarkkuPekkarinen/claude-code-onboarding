...
2. Check each review area below in priority order (P0 first)
3. For each issue found, report with severity, file, line, and specific fix
4. Summarize findings with a verdict: APPROVE, REQUEST CHANGES, or BLOCK
...
- `agentic-templates-agents.md` — Graph patterns
